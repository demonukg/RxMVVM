...
protocol ComicsViewControllerInterface: UIViewController {
    
    var comics: PublishSubject<[Comics]> { get }
    
}

final class ComicsViewController<ViewModel: AlbumViewModel>: MVVMViewController<ComicsView, ViewModel>, ComicsViewControllerInterface, UICollectionViewDelegateFlowLayout {
    ...
    override func bind(view: ComicsView) {
        ...
        view.collectionView.rx.setDelegate(self).disposed(by: disposeBag)
